        ...
        try {
            ...
            if(cookies != null) {
	            for(Cookie c : cookies) {
	                ...
	                out.println("<td><a href=\"#\" onclick=\"jCookies.del('" + c.getName() + "');return false;\">Eliminar</a></td>");
	                out.println("</tr>");
	            }
            }
            out.println("<tr>");
            out.println("<td><input type=\"text\" name=\"cookieName\"  value=\"\" maxlength=\"255\" size=\"30\"/></td>");
            out.println("<td><input type=\"text\" name=\"cookieValue\" value=\"\" maxlength=\"255\" size=\"30\"/></td>");
            out.println("<td>&nbsp;</td>");
            out.println("</tr>");
            out.println("</tbody>");
            out.println("</table>");
            out.println("<br/>");
            out.println("<a href=\"#\" onclick=\"jCookies.add();return false;\">Agregar</a>");
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
		}
