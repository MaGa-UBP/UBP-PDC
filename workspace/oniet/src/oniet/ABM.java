...
public class ABM {
	...
	public static usuario getPunto3(Connection connection, String compradorBuscado){
		String select3= "SELECT orders.BuyerNickname, SUM(orders.TotalAmount) as 'montototal', orders.PaymentType, orders.SellerNickname FROM `orders` WHERE orders.BuyerNickname='"+compradorBuscado+"'";
	...
	u.totalCompra=rs.getDouble("montototal");
	String medioss=rs.getString("PaymentType");
	ArrayList<String>listaMedios= new ArrayList<String>();
