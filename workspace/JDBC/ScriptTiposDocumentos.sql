...
/*
drop procedure dbo.get_datos_tipo_documento
drop procedure dbo.del_tipo_documento
*/
...
/* --------------------------------------------------
   ...
   -------------------------------------------------- */
create procedure dbo.get_datos_tipo_documento
(
...
/* --------------------------------------------------
   ...
   -------------------------------------------------- */
create procedure dbo.del_tipo_documento
(
 @cod_tipo_documento	varchar(6)
)
as
