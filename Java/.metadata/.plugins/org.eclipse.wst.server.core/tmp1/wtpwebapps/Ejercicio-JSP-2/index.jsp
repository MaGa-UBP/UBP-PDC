		...
		<form method="POST" id="prodeForm" action="index.jsp">
			<table>
				...
				for(List<String> match : equipos){
					...
					out.println("<td><input type=\"checkbox\" name=\"resultado-"+i+"\" value=\"izq\" "+checkedL+" "+disabled+"></td>");
					out.println("<td><input type=\"checkbox\" name=\"resultado-"+i+"\" value=\"empate\" "+checkedE+" "+disabled+"></td>");
					out.println("<td><input type=\"checkbox\" name=\"resultado-"+i+"\" value=\"der\" "+checkedR+" "+disabled+"></td>");
