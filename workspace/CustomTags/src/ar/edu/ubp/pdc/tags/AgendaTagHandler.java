...
public class AgendaTagHandler extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
        try {
            ...
            this.agenda.add(new Tarea("Cumpleaños de Pili", f.parse("07-03-2017"), Prioridad.ALTA));
            this.agenda.add(new Tarea("Cumpleaños de Silvana", f.parse("16-05-2017"), Prioridad.ALTA));
            this.agenda.add(new Tarea("Ir a comprar regalo para Silvana...", f.parse("07-05-2017"), Prioridad.MEDIA, "Mariela"));
            this.agenda.add(new Tarea("Clase de PDC", f.parse("12-04-2017"), Prioridad.ALTA, "Mariela"));
