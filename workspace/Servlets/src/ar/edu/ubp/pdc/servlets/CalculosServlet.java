...
public class CalculosServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<script type=\"text/javascript\" src=\"./js/ejemplo2.js\"></script>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>C&aacute;lculos</h3>");
            out.println("<form id=\"form\" name=\"form\" action=\"ejemplo2.jsp\" method=\"post\">");
            out.println("<p>Variable 1: <input type=\"text\" name=\"variable1\" value=\"\" size=\"10\" maxlength=\"10\" onkeydown=\"jNumber.allowOnlyNumbers(event)\" /></p>");
            out.println("<p>Variable 2: <input type=\"text\" name=\"variable2\" value=\"\" size=\"10\" maxlength=\"10\" onkeydown=\"jNumber.allowOnlyNumbers(event)\" /></p>");
            out.println("<input type=\"button\" value=\"Calcular\" onclick=\"jNumber.validForm()\"/>");
            out.println("</form>");
            out.println("<br/>");
